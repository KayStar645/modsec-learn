"""
Script này vẽ đường cong ROC cho các mô hình học máy đã huấn luyện sẵn
và so sánh với ModSecurity WAF.
"""
...
if  __name__ == '__main__':
    ...
    # BẮT ĐẦU CHẠY THÍ NGHIỆM CHO TỪNG MỨC PARANOIA LEVEL
    for pl in paranoia_levels:
        ...
        for model_name in other_models:
            print('[INFO] Đang đánh giá mô hình {} tại PL {}...'.format(model_name, pl))
    ...
    # Thiết lập cuối cùng cho toàn bộ hình
