"""
Script này huấn luyện các mô hình với nhiều mức Paranoia Level (PL) và các kiểu
chuẩn phạt khác nhau, sau đó lưu mô hình dưới dạng tệp joblib trong thư mục
`models`.
"""
...
if __name__        == '__main__':
    ...
    # GIAI ĐOẠN NẠP DỮ LIỆU HUẤN LUYỆN
    ...
    for pl in paranoia_levels:
        # GIAI ĐOẠN TRÍCH XUẤT ĐẶC TRƯNG TƯƠNG ỨNG PL
        print('[INFO] Đang trích xuất đặc trưng cho PL {}...'.format(pl))
        ...
        # GIAI ĐOẠN HUẤN LUYỆN CHO TỪNG MÔ HÌNH
        for model_name in models:
            print('[INFO] Đang huấn luyện mô hình {} cho PL {}...'.format(model_name, pl))
